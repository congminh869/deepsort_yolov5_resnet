    ...
    for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
        ...
        for i, det in enumerate(pred): # detections per image
            ...
            if det is not None and len(det):
                ...
                outputs = deepsort.update(xywhs.cpu(), confs.cpu(), clss, im0) #outputs =  [[   7  162  531 1077    1    0]] , [x1, y1, x2, y2, track_id, class_id]
            ...
            # save_path = 'inference/demoresnet/'
            if True:
...
if __name__ == '__main__':
    ...
    # for i in range(8,11):
        ...
        parser.add_argument('--savebus', type=str, default='./orange/video'+str(i)+'/', help='save')  # output folder
